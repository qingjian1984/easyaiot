...
| 模型名称 | 推理格式 | 版本 | 能力说明 |
| :-- | :--: | :--: | :-- |
| 安全帽模型 | ONNX | v1.0.1 | 检测作业人员是否佩戴安全帽 |
| 睡岗模型 | PyTorch | v1.0.0 | 识别岗位人员睡岗、脱岗等异常行为 |
| 人模型 | PyTorch | v1.0.0 | 通用人体检测，用于画面中人员的识别与定位 |
| 车牌识别 | ONNX | v1.0.0 | 识别车辆号牌信息 |
| 反光衣模型 | PyTorch | v1.0.0 | 检测作业人员是否穿着反光衣 |
| 火焰模型 | PyTorch | v1.0.0 | 识别明火、火焰等火灾隐患 |
| 吸烟模型 | PyTorch | v1.0.0 | 识别人员吸烟行为 |
| 打电话模型 | ONNX | v1.0.0 | 识别人员打电话、使用手机等行为 |
| 道路积水模型 | ONNX | v1.0.0 | 识别道路积水、路面积水等异常状况 |
| 口罩模型 | ONNX | v1.0.0 | 检测人员是否正确佩戴口罩 |
| 跌倒检测模型 | ONNX | v1.0.0 | 识别人员跌倒等异常姿态 |
| 人脸检测模型 | ONNX | v1.0.0 | 检测画面中人脸位置，支撑人脸识别链路 |
