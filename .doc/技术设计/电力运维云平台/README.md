...
| [TD-005](./TD-005-物模型模板Schema版本差异与发布API.md) | 物模型模板 Schema、版本差异、导入资产、产品绑定及发布 API（1.0.6；孤儿存量子门禁 PASS） | In Review | ADR-012 Accepted、Mapper/运行表合同、生产 Java/TypeScript golden、恶意导入 fixture、行业模板、发布/租户/回滚证据和资产 commit/hash 均通过评审 |
