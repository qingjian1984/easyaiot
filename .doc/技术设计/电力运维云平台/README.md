...
| [M1-LC-03](./M1-LC-03-成功ACK-V1与重启对账任务单.md) | 成功 ACK V1、collector 精确订阅、center 即时发送与重启补发 | In Progress（LC03-01/02/03 SOL-ACCEPTED） | LC03-03 Sol 复核三轮 59/59 + test-compile SUCCESS，含即时 ACK 接线缺口修复（§15.6）；V012/U012 候选与隔离合同脚本已备未执行；LC03-04 FROZEN 待授权（真实隔离 broker/PG 另授权）；LC03-05 LOCKED |
