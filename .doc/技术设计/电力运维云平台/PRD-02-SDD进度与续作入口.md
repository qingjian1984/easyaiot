...
> 最近归档：`20c226ec1 test(prd-02): add G2-03 protocol evidence verifier`
...
| C1P-G2 | [输入单 0.5.0](./P02-M2-02C1P-G2-责任人输入收集与建议处置单.md)、[处置记录 0.4.0](./P02-M2-02C1P-G2-输入处置记录.md)、[G2-02 Owner 确认单](./P02-M2-02C1P-G2-02-投影事件Owner确认单.md)、[G2-03 Owner 确认单](./P02-M2-02C1P-G2-03-设备事件协议证据与Owner确认单.md)、[G2-04 Owner 确认单](./P02-M2-02C1P-G2-04-设备事件产品Allowlist与Owner确认单.md) | G2-01 部分接受、待 activation/勘误；G2-02 待 M1 owner；G2-03 验收器已准备但全部协议关闭；G2-04 合同已准备且 DENY_ALL；C1 关闭 |
...
| [P02-M2-02C1P-G2](./P02-M2-02C1P-G2-责任人输入收集与建议处置单.md) | 四类责任人输入的仓库事实、推荐选择、签署字段和关闭顺序 | **G2-01 Partial-Accepted / G2-02 Prepared / G2-03 Local-Verifier-Prepared / G2-04 Contract-Prepared + Deny-All / C1 Closed**；不得把验收工具或部分签署解释为实现授权 |
...
2. 至少一个 G2-03 direct 协议通过并标记 ENABLED 后，产品 owner 再按 [G2-04 Owner 确认单](./P02-M2-02C1P-G2-04-设备事件产品Allowlist与Owner确认单.md)提交 mapping、基础四类 fixture、COMPLETE review package、APPROVED allowlist 和签署；此前保持 `DENY_ALL`。
