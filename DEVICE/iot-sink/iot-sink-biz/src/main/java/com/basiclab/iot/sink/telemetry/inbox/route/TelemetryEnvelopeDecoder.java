...
final class TelemetryEnvelopeDecoder {
    ...
    DecodeResult decode(byte[] payload) {
        ...
        try {
            ...
            if (tenantId.isEmpty()) {
                ...
                return new Decoded(buildEnvelope(payload, messageId, requestId, tenantId,
    ...
    private InboxEnvelope buildEnvelope(byte[] payload, String messageId, String requestId,
        ...
        try {
            ...
            throw new IllegalArgumentException("invalid envelope", exception);
        }
        ...
        return new InboxEnvelope(messageId, requestId, tenantId, siteCode,
                deviceIdentification, propertyCode, payload, sha256(payload),
                collectedAtMs, sequence, effectiveSource, configVersion);
    }
    ...
    record Decoded(InboxEnvelope envelope) implements DecodeResult {
    }
