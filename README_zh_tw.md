...
| 模型名稱 | 推理格式 | 版本 | 能力說明 |
| :-- | :--: | :--: | :-- |
| 安全帽模型 | ONNX | v1.0.1 | 檢測作業人員是否佩戴安全帽 |
| 睡崗模型 | PyTorch | v1.0.0 | 識別崗位人員睡崗、脫崗等異常行為 |
| 人模型 | PyTorch | v1.0.0 | 通用人體檢測，用於畫面中人員的識別與定位 |
| 車牌識別 | ONNX | v1.0.0 | 識別車輛號牌信息 |
| 反光衣模型 | PyTorch | v1.0.0 | 檢測作業人員是否穿著反光衣 |
| 火焰模型 | PyTorch | v1.0.0 | 識別明火、火焰等火災隱患 |
| 吸煙模型 | PyTorch | v1.0.0 | 識別人員吸煙行為 |
| 打電話模型 | ONNX | v1.0.0 | 識別人員打電話、使用手機等行為 |
| 道路積水模型 | ONNX | v1.0.0 | 識別道路積水、路面積水等異常狀況 |
| 口罩模型 | ONNX | v1.0.0 | 檢測人員是否正確佩戴口罩 |
| 跌倒檢測模型 | ONNX | v1.0.0 | 識別人員跌倒等異常姿態 |
| 人臉檢測模型 | ONNX | v1.0.0 | 檢測畫面中人臉位置，支撐人臉識別鏈路 |
