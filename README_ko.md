...
| 모델 이름 | 추론 형식 | 버전 | 기능 설명 |
| :-- | :--: | :--: | :-- |
| 안전모 모델 | ONNX | v1.0.1 | 작업자의 안전모 착용 여부 검출 |
| 수면 근무 모델 | PyTorch | v1.0.0 | 근무 중 수면, 이탈 등 이상 행동 식별 |
| 사람 검출 모델 | PyTorch | v1.0.0 | 화면 내 사람 식별 및 위치 파악을 위한 범용 인체 검출 |
| 번호판 인식 | ONNX | v1.0.0 | 차량 번호판 정보 인식 |
| 반사 조끼 모델 | PyTorch | v1.0.0 | 작업자의 반사 조끼 착용 여부 검출 |
| 화염 모델 | PyTorch | v1.0.0 | 개방 화염, 화재 위험 식별 |
| 흡연 모델 | PyTorch | v1.0.0 | 흡연 행동 식별 |
| 통화 모델 | ONNX | v1.0.0 | 통화 및 휴대폰 사용 행동 식별 |
| 도로 침수 모델 | ONNX | v1.0.0 | 도로 침수, 노면 적수 등 이상 상황 식별 |
| 마스크 모델 | ONNX | v1.0.0 | 마스크 올바른 착용 여부 검출 |
| 낙상 검출 모델 | ONNX | v1.0.0 | 낙상 등 이상 자세 식별 |
| 얼굴 검출 모델 | ONNX | v1.0.0 | 화면 내 얼굴 위치 검출, 얼굴 인식 파이프라인 지원 |
