...
| Название модели | Формат инференса | Версия | Возможности |
| :-- | :--: | :--: | :-- |
| Модель каски | ONNX | v1.0.1 | Определение, носят ли работники защитные каски |
| Модель сна на посту | PyTorch | v1.0.0 | Выявление сна на посту, ухода с поста и другого аномального поведения |
| Модель обнаружения людей | PyTorch | v1.0.0 | Универсальное обнаружение людей для идентификации и локализации в кадре |
| Распознавание номеров | ONNX | v1.0.0 | Распознавание информации с автомобильных номеров |
| Модель светоотражающего жилета | PyTorch | v1.0.0 | Определение, носят ли работники светоотражающие жилеты |
| Модель пламени | PyTorch | v1.0.0 | Обнаружение открытого пламени и пожарных рисков |
| Модель курения | PyTorch | v1.0.0 | Выявление курения |
| Модель телефонных звонков | ONNX | v1.0.0 | Выявление звонков и использования мобильного телефона |
| Модель затопления дороги | ONNX | v1.0.0 | Обнаружение скопления воды на дороге и подтопления |
| Модель маски | ONNX | v1.0.0 | Определение правильного ношения масок |
| Модель обнаружения падений | ONNX | v1.0.0 | Выявление падений и других аномальных поз |
| Модель обнаружения лиц | ONNX | v1.0.0 | Определение положения лиц в кадре для поддержки распознавания лиц |
